...
export default function AccountPage() {
  ...
  const orders = useQuery({ queryKey: ["customer", "orders"], queryFn: getOrders, enabled: Boolean(customer), retry: false });
